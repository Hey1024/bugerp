<template>
  <div class="app-container">
    ...
    <el-table :key='tableKey' :data="userlist" v-loading="listLoading" border fit highlight-current-row
      ...
      <el-table-column width="110px" align="center" :label="$t('table.realname')">
        <template slot-scope="scope">
      ...
      <!--<el-table-column min-width="150px" align="center" :label="$t('table.title')">-->
        ...
        <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column width="110px" align="center" :label="$t('table.nickname')">
        <template slot-scope="scope">
      ...
      <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column width="130px" align="center" :label="$t('table.role')">
        <template slot-scope="scope">
      ...
      <!--</template>-->
      <!--</el-table-column>-->
      <el-table-column class-name="status-col" :label="$t('table.email')" width="200">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" :label="$t('table.actions')" width="230" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="primary" size="mini" v-show="scope.row.show" @click="handleResetPwd(scope.row)">{{$t('table.reset')}}</el-button>
